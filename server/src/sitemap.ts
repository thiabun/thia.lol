...
class MariaDbSitemapService implements SitemapService {
  ...
  async xml(): Promise<string> {
    const urls: SitemapUrl[] = [
      ...
      sitemapUrl(this.baseUrl, "/legal", null, "monthly"),
      sitemapUrl(this.baseUrl, "/terms", null, "monthly"),
      sitemapUrl(this.baseUrl, "/privacy", null, "monthly"),
      sitemapUrl(this.baseUrl, "/cookies", null, "monthly"),
      ...
      sitemapUrl(this.baseUrl, "/data-export", null, "monthly"),
      sitemapUrl(this.baseUrl, "/account-deletion", null, "monthly"),
      sitemapUrl(this.baseUrl, "/refunds", null, "monthly"),
      sitemapUrl(this.baseUrl, "/appeals", null, "monthly"),
      sitemapUrl(this.baseUrl, "/safety", null, "monthly"),
      sitemapUrl(this.baseUrl, "/content-ownership", null, "monthly"),
      sitemapUrl(this.baseUrl, "/no-dark-patterns", null, "monthly"),
      sitemapUrl(this.baseUrl, "/monetization-ethics", null, "monthly"),
      sitemapUrl(this.baseUrl, "/ai-policy", null, "monthly"),
      sitemapUrl(this.baseUrl, "/security", null, "monthly"),
      sitemapUrl(this.baseUrl, "/vulnerability-disclosure", null, "monthly"),
      sitemapUrl(this.baseUrl, "/transparency", null, "monthly"),
      sitemapUrl(this.baseUrl, "/law-enforcement", null, "monthly"),
      sitemapUrl(this.baseUrl, "/creator-marketplace", null, "monthly"),
      sitemapUrl(this.baseUrl, "/accessibility", null, "monthly"),
      sitemapUrl(this.baseUrl, "/incident-response", null, "monthly"),
    ];
