...
$withoutCustomization = profile_update_statement_for_body($legacyNoopPayload, 123, false);
...
$snakeCase = profile_update_statement_for_body($snakeCasePayload, 123, true);
